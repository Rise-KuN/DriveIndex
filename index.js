...
const uiConfig = {
  ...
  "version": "2.4.0", // don't touch this one. get latest code using generator at https://bdi-generator.hashhackers.com
  ...
  "logo_link_name": "", // Dont use it because i added new logo code to app.js
  "login_image": "", // logo image
  "website_name": "Drive DDL",
...
const player_config = {
  "player": "dplayer", // videojs || plyr || dplayer || jwplayer
...
if (environment === 'production') {
  //app_js_file = uiConfig.jsdelivr_cdn_src + '@' + uiConfig.version + '/src/app.min.js'
    app_js_file = 'https://cdn.jsdelivr.net/gh/Rise-KuN/DriveIndex/app_v1.0.5.js'
...
<head>
    ...
    <style>
        body {
            font-family: 'Modern Antiqua', 'El Messiri', sans-serif !important;
                background: #121212;
        }
        body > header {
            font-family: 'Modern Antiqua', 'El Messiri', sans-serif !important;
      ...
      <nav class="navbar navbar-expand-lg${uiConfig.fixed_header ?' fixed-top': ''} ${uiConfig.header_style_class}">
         ...
         <a class="navbar-brand" href="/">${uiConfig.logo_image ? '<img border="0" alt="'+uiConfig.company_name+'" src="'+uiConfig.logo_link_name+'" height="'+uiConfig.height+'" width="'+uiConfig.logo_width+'">' : uiConfig.logo_link_name}</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
           <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
               <a class="nav-link" href="${uiConfig.website_link}" target="_blank">${uiConfig.nav_link_website}</a>
            </li>
        ...
        <div class="ct-wrapper">
            <div class="header logo-wrapper section" id="Logo-section">
                <div id="header-inner">
                    <a href="${uiConfig.website_link}" class="custom-logo-link" rel="home" aria-current="page">
                        <img width="1200" height="500" src="${uiConfig.login_image}" class="custom-logo" alt="${uiConfig.website_name}" decoding="async" fetchpriority="high">
                    </a> 
                </div>
            </div>
        </div>
...
const login_html = `<html>
   <head>
    ...
    <style>
     .logo {
     font-family: 'Modern Antiqua', 'El Messiri', sans-serif;
     color: #007bff;
     }
    </style>
